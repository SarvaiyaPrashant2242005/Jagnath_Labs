...
const create = async (req, res) => {
    try {
        ...
        const reportData = {
            ...
            reviewedBySignature: value.reviewedBySignature || null,
...
const update = async (req, res) => {
    try {
        ...
        const reportData = {
            ...
            reviewedBySignature: value.reviewedBySignature !== undefined ? value.reviewedBySignature : report.reviewedBySignature,
