  ...
  return (
    <div className="print-standalone-container">
      ...
      {(() => {
        ...
        return (
          <>
            <div className="doc-page-container" style={{ width: '100%', minHeight: 'auto', padding: '12mm 15mm 10mm 15mm', fontSize: '11px', background: '#ffffff', position: 'relative', display: 'flex', flexDirection: 'column' }}>
              {/* TOP HEADER: LOGO */}
              <div style={{ textAlign: 'center', marginBottom: '8px' }}>
                <img
                  src={getLogoUrl(company)}
