...
const CategoryMaster = () => {
  ...
  const handleDownloadCSV = () => {
    ...
    const headers = ['Category Name', 'Description', 'Company Name', 'Status'];
              ...
              {loading ? (
                ...
                filteredCategories.map((cat, index) => (
                  ...
                  >
                    ...
                    <td style={{ padding: '0.75rem 1rem', fontWeight: 600, color: '#0f172a' }}>{cat.name}</td>
                    <td style={{ padding: '0.75rem 1rem', color: '#64748b', maxWidth: '280px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {cat.description || <em style={{ color: '#94a3b8' }}>No description</em>}
                    </td>
                    <td style={{ padding: '0.75rem 1rem', color: '#475569' }}>{cat.companyName || 'N/A'}</td>
                    <td style={{ padding: '0.75rem 1rem' }}>
                      <span 
                        ...
                        style={{
                          ...
                          color: cat.status === 'Active' ? '#15803d' : '#991b1b',
                          cursor: 'pointer',
                          userSelect: 'none'
                        }}
                      >
